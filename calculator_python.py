...
root = tkinter.Tk()
root.geometry("250x400+300+300")  #tkinter window size
root.resizable(0,0)               #its window cannot be expand or minimize
...
def btn_1_isclicked():    #button for running button 1
    global val
    val = val + "1"         #concatinating string
    data.set(val)
